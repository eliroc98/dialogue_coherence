...
[Liu et al., “How NOT To Evaluate Your Dialogue System.”](https://aclanthology.org/D16-1230)[^liu2016] and [Novikova et al., “Why We Need New Evaluation Metrics for NLG.”](https://aclanthology.org/D17-1238)[^novikova2017] (👩‍💻 [GitHub](https://github.com/jeknov/EMNLP_17_submission)) demonstrate that these metrics correlate poorly with human judgments due to the absence of semantic information.
- Liu et al.[^liu2016] also provides a good summary of the existing evaluation metrics in 2016 (word-overlap metrics and embedding-based metrics)
